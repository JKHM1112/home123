...
<nav class="navbar">
	<div class="navbar_logo">
		<i class="fa-solid fa-map-location-dot"></i> <a href="start.jsp">여행가기
			좋은날</a>
	</div>
...
<body>
	<a
		style="display: scroll; position: fixed; bottom: 20px; right: 60px; font-size: 40px;"
