...
<script language="javascript">
	function goPopup() {
		var pop = window.open("overlapid.jsp", "pop",
			...
			<section class="signup-wrap">
				...
				<div>
					...
					<span class="signup-input"> <input id="signup-id"
						type="text"></input> <span class="signup-at"></span> <input
						id="overlab" type="button" onClick="goPopup();" value="중복확인하기" />
					</span>
					<h3>비밀번호</h3>
				...
				<div style="margin-top: 35px;">
					...
					<span class="choice">
						<h3>본인 확인 질문</h3>
						<select id="checkquestion" class="selectbox" name="question"
						onchange="">
